  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      ...
      <div className="flex justify-center my-10">
        <a href="#" className="text-lg bg-gradient-to-r from-orange-500 to-red-800 py-3 px-4 mx-3 rounded-md">Start for free</a>
        <a href="#" className="text-lg rounded-md py-3 px-4 border mx-3">Documentation</a>
